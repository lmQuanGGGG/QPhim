...
export const metadata = {
  title: 'Phim lẻ mới nhất | QMovie',
  description: 'Xem phim lẻ chiếu rạp, phim lẻ hay mới nhất',
};
...
export default async function PhimLePage({
  ...
  const data = await movieService.getSingleMovies(currentPage);
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black pt-28 pb-20">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24">
        ...
        <div className="flex items-center gap-4 mb-14">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">Phim Lẻ</h1>
