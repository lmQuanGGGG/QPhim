...
export const metadata = {
  title: 'Phim bộ mới nhất | QMovie',
  description: 'Xem phim bộ Hàn Quốc, Trung Quốc, Âu Mỹ mới nhất, hot nhất',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black pt-28 pb-20">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24">
        ...
        <div className="flex items-center gap-4 mb-14">
          <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-3.5 rounded-2xl shadow-lg">
            <FilmIcon className="w-8 h-8 text-white" />
          </div>
          <div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">Phim Bộ</h1>
